    ...
    <section class="bg-base-200">
        ...
        <div class="grid grid-cols-2 gap-6 px-6 py-16 md:grid-cols-3 lg:px-16">
            @foreach ($extracurriculars as $eskul)
                <div class="group card w-full overflow-hidden bg-slate-100 shadow-lg">
                    <img class="h-[300px] w-full rounded-t-2xl object-cover transition-transform group-hover:scale-105"
