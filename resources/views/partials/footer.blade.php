    ...
    <div class="col-span-1 grid w-full grid-cols-2 justify-between gap-2 lg:flex lg:justify-around">
        ...
        <nav class="py-2">
            ...
            <div class="flex gap-4">
                ...
                <a class="cursor-pointer rounded-full p-2 hover:bg-green-500"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a class="cursor-pointer rounded-full p-2 hover:bg-red-500"><svg xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 24 24" class="fill-current">
                        <path
