                    ...
                    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                        <div
                            ...
                            <div class="relative drop-shadow-2">
                                <img src="{{ asset('images/company.png') }}" alt="profile">
                                <label for="profile"
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-6.5">
                                ...
                                <div class="flex items-center justify-center gap-3.5">
                                    ...
                                    <a href="#" class="hover:text-primary" name="social-icon"
                                        aria-label="social-icon">
                                        <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_30_970">
                                                    <rect width="22" height="22" fill="white"
                                                        transform="translate(0.666138)"></rect>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </a>
                                        ...
                                        <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22"
                                            ...
                                            <defs>
                                                <clipPath id="clip0_30_974">
                                                    <rect width="22" height="22" fill="white"
                                                        transform="translate(0.333862)"></rect>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </a>
