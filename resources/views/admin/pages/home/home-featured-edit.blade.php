            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li>
                            <a class="font-medium" href="/admin/home/program-unggulan">Program Unggulan /</a>
                        </li>
            ...
            <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
                <div class="flex flex-col gap-9">
                    ...
                    <div
                        ...
                        <form action={{ route('home.featured.update', $featured->id) }} method="POST"
                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="featured_title" value="{{ $featured->featured_title }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="featured_subtitle"
                                        value="{{ $featured->featured_subtitle }}"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
