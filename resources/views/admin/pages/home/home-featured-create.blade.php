            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li>
                            <a class="font-medium" href="/admin/profil/guru-staf">Program Unggulan /</a>
                        </li>
                        <li class="font-medium text-primary">Program Unggulan Create</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div
                        ...
                        <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                            <h3 class="font-medium text-black dark:text-white">
                                Program Unggulan Form
                            </h3>
                        </div>
                        <form action={{ route('home.featured.store') }} method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="p-6.5">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="featured_title" placeholder="Masukkan Title"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="featured_subtitle" placeholder="Masukkan Subtitle"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
