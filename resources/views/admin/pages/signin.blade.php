...
<head>
    ...
    <title>
        Sign In-Admin | SD Muhammadiyah Klaten Utara
    </title>
                        ...
                        <div class="flex flex-wrap items-center">
                            <div class="hidden w-full xl:block xl:w-1/2">
                                <div class="px-26 py-17.5 text-center">
                                    <a class="mb-5.5 flex items-center justify-center gap-2" href="#">
                                        <img class="h-16 w-16" src="{{ asset('images/logo/logo_sdmku_compress.png') }}"
                                            alt="Logo" />
                                        <span class="font-lobster text-xl font-bold">ADMIN | SD MUHAMMADIYAH KLATEN
                                            UTARA</span>
                                    </a>

                                    <span class="mt-15 inline-block">
                                        <img class="h-72" src="{{ asset('images/default/illustration-03.svg') }}"
                                            alt="illustration" />
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                    ...
                                    <form action="{{ route('admin.login_process') }}" method="POST">
                                        ...
                                        <div class="mt-6 text-center">
                                            <a href="/home" class="font-medium hover:underline">
