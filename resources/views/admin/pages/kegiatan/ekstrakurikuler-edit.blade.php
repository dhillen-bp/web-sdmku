            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li class="font-medium text-primary">Ekstrakurikuler Edit</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <form action="{{ route('admin.extra.update', $extra->id) }}" method="POST">
                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="position" value="{{ $extra->desc }}" required
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="image_gdrive"
                                        value="{{ Str::contains($extra->image, 'drive') ? $extra->image : 'Anda mengupload file di storage' }}"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
