            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li>
                            <a class="font-medium" href="{{ route('admin.event.index') }}">Event Terbaru /</a>
                        </li>
                        <li class="font-medium text-primary">Event Terbaru Create</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <form action="{{ route('admin.event.update', $event->id) }}" method="POST"
                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea rows="6" name="caption" id="caption"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ $event->caption }}</textarea>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="image_gdrive"
                                        value="{{ Str::contains($event->image, 'drive') ? $event->image : 'Anda mengupload file di storage' }}"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
